...
namespace BugTracker.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProjectId,TicketTypeId,TicketStatusId,TicketPriorityId,CreatorId,DeveloperId,Title,Description,Created,Updated,Archived")] Ticket ticket)
        {
            ...
            ViewData["CreatorId"] = new SelectList(_context.Users, "Id", "Id", ticket.CreatorId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProjectId,TicketTypeId,TicketStatusId,TicketPriorityId,CreatorId,DeveloperId,Title,Description,Created,Updated,Archived")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
