...
namespace BugTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,UserId,Created,Comment")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,UserId,Created,Comment")] TicketComment ticketComment)
        {
