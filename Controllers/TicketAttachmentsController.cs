...
namespace BugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,UserId,Created,Description,FileData,FileName,FileType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,UserId,Created,Description,FileData,FileName,FileType")] TicketAttachment ticketAttachment)
        {
